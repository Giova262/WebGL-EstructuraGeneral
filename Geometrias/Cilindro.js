class Cilindro extends SuperficieDeRevolucion{
    ...
    initControlPoints(){
        ...
        var p1 = [this.radioInterior,0,this.altura];
        var p2 = [this.radioExterior,0,this.altura];
        var p3 = [this.radioExterior,0,this.altura];

        var p4 = [this.radioExterior,0,this.altura];
        var p5 = [this.radioExterior,0,this.altura];
        var p6 = [this.radioExterior,0,0];
        var p7 = [this.radioExterior,0,0];

        var p8 = [this.radioExterior,0,0];
        var p9 = [this.radioExterior,0,0];
        var p10 = [this.radioInterior,0,0];
        var p11 = [this.radioInterior,0,0];

        var p12 = [this.radioInterior,0,0];
        var p13 = [this.radioInterior,0,0];
        var p14 = [this.radioInterior,0,this.altura];
